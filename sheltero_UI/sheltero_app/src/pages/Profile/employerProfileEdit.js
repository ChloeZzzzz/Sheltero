...
class EmployerEdit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      userImg: null,
      imgPreview:
        "http://www.sangathipl.com/wp-content/uploads/2016/07/no-image-avaliable.jpg"
      // redirect: null,
    };
  ...
  handleSubmit(event) {
    axios
      .post("https://shelteroinf.herokuapp.com/user/updateUser", this.state, {
  ...
  fileSelectedHandler = event => {
    ...
    reader.onload = () => {
      if (reader.readyState === 2) {
        //readyState provides the current state of the reading operation, if file upload is complete
  ...
  fileUploadHandler = () => {
    ...
    axios
      .post("https://shelteroinf.herokuapp.com/user/updateUser", formData)
      .then(res => {
        console.log(res);
      });
  };
                ...
                <Card>
                  ...
                  <CardBody className={classes.paper}>
                    ...
                    <GridContainer>
                      ...
                      <GridItem xs={12} sm={12} md={12}>
                        <SecButton onClick={() => this.fileInput.click()} round>
                          Choose File
                        </SecButton>
                        <SecButton onClick={this.fileUploadHandler}>
                          Upload
                        </SecButton>
                        <SecButton onClick={this.fileRemoveHandler} round>
                          Remove
                        </SecButton>
                      </GridItem>
                    </GridContainer>
